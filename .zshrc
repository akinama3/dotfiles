...
PATH=/usr/local/opt/libxml2/bin:$HOME/bin:$HOME/.bin:$HOME/.pyenv/shims:$HOME/.rbenv/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:/usr/local/Omnisharp/bin:/Applications/platform-tools:/Applications/android-sdk-macosx/tools:/usr/local/opt/go/libexec/bin:/Applications/neovim-dot-app/bin:/usr/local/opt/imagemagick@6/bin:/usr/local/google-cloud-sdk/bin
